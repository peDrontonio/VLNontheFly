#!/usr/bin/env python3
#
# MPC controller — OptiTrack test variant.
#
# Functionally identical to controller.py; kept separate so OptiTrack experiments
# can diverge without touching the original. Consumes /odometry (from
# odometry_converter_optitrack.py) and /trajectory, publishes /cmd_vel.
...
class ControllerNode(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info("Controller node (OptiTrack) started.")
