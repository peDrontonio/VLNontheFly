#!/usr/bin/env python3
#
# IPlanner node — OptiTrack test variant.
#
# Functionally identical to iplanner.py; kept as a separate file so the OptiTrack
# experiments can diverge without touching the original. Odometry on /odometry is
# expected to come from odometry_converter_optitrack.py (PX4-fused OptiTrack).
...
class PlannerNode(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info("Planner node (OptiTrack) started.")
